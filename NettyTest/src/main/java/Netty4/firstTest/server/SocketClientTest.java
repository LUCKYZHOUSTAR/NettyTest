...
public class SocketClientTest {
    ...
    private void writeXMLWithPreLen(OutputStream out, byte[] data) throws IOException {
        ...
        //此处是关键的地方
        String len = String.format("%08d", new Object[] { data.length });
...
//        System.out.println(String.format("%08d", new Object[] { "你红啊吗".getBytes().length }));
        String result = new SocketClientTest().sendXML("100.66.153.98", 8888, "你好吗,我很好啊，你呢，你怎么样呢");
